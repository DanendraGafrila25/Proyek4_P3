...
class ProductsRepository {
  static get allProducts => null;

  static get productNames => null;
  ...
  static List<Product> searchProductsById(int id) {
    return allProducts.where((product) => product.id == id).toList();
  }
}
